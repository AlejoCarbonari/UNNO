...
<div class="modal fade" id="modal-lg-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 style="color: black;" class="modal-title text-center" id="exampleModalLongTitle"><i class='fas fa-pencil-alt' style='padding-right: 10px; color: orange; font-size: 19px;'></i>Cliente<small style="color: orange;"> editar</small></h3>
      </div>
      <div class="modal-body">
        <form method="POST" class="form-group">
                <div class="row">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="saveClientEditable" class="btn btnRosa">Guardar</button>
      </div>
    </div>
  </div>
</div>
